const projects = [
  ...
  },
  {
    ...
    description: "A fine-tuned ResNet50 model trained to classify axial-view MRI scans of brain tumors. The model achieved an accuracy of 99% on the 4-class tumor classification task. This project explored the impact of data augmentation and transfer learning on model performance.",

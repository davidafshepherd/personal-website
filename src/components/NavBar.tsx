    ...
    <header className={`sticky top-0 z-50 backdrop-blur-md border-b transition-all duration-300 ${
      ...
      {isMobile && isMenuOpen && (
        <div className="border-t border-gray-200 bg-white/95 backdrop-blur-md">
          <div className="mx-auto max-w-5xl px-4 sm:px-6 py-3 space-y-4">
            {/* Social icons (mobile) */}
              ...
              <li key={l.href}>
                <a
                  href={l.href}
                    ...
                    className="block px-3 py-2 text-sm font-medium text-gray-700 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200"
                >
                  {l.label}
                </a>
              </li>

...
export default function NavBar() {
  ...
  return (
    <header className={`sticky top-0 z-50 backdrop-blur-md border-b transition-all duration-300 ${
      ...
      <nav className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8 h-14 flex items-center justify-between relative">
        {/* Left: Name */}
        <a 
          href="#" 
          onClick={scrollToTop}
          className="font-semibold text-sm sm:text-base hover:text-blue-600 transition-colors cursor-pointer z-10"
        >
          David Afonso Shepherd
        </a>
        
        {/* Middle: Social Icons - Absolutely centered */}
        <div className="hidden sm:flex items-center gap-2 absolute left-1/2 -translate-x-1/2">
          ...
          {/* Email */}
          <a 
            href="mailto:davidafonsoshepherd@gmail.com"
            className="p-2 text-gray-600 hover:text-blue-600 hover:bg-blue-50 rounded-lg transition-all duration-200"
            aria-label="Email"
          >
